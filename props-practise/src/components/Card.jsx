...
const Card = (props) => {
    console.log(props)
  return (
    <div className=' p-5 flex items-center justify-center bg-transparent border-2 border-white rounded-sm text-white'>
        <h1 className='text-6xl text-center '>{props.user}</h1>
